                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full px-8 py-20 bg-surface-0 dark:bg-surface-900 sm:px-20" style="border-radius: 53px">
                        ...
                        <div>
                            ...
                            <label for="password2" class="block mb-2 text-xl font-medium text-surface-900 dark:text-surface-0">Confirm Password</label>
                            <Password id="password2" v-model="confirmPassword" placeholder="Password" :toggleMask="true" class="mb-4" fluid :feedback="false"></Password>

                            <div class="flex items-center justify-between gap-8 mt-2 mb-8">
                                <router-link to="/auth/login" class="ml-2 font-medium text-right no-underline cursor-pointer text-primary"> Already have an account? </router-link>
                            </div>
